...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_folder', default='./data/widerface/images/', type=str, help='dataset path')#images是原始数据集val中的images!
    # parser.add_argument('--folder_pict', default='./data/widerface/val/wider_val.txt', type=str, help='folder_pict')#
    parser.add_argument('--folder_pict', default='./data/wider_val.txt', type=str, help='folder_pict')#
